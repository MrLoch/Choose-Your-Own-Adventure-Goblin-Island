...
''')
    print(
        "The world is vast, the treasures many, and the dangers even greater. Step forward, and your story begins. Welcome to Goblin Island.")
    print(
        "Legends speak of a goblin’s treasure hidden somewhere in the area. Your task: claim it… and live to tell the tale.")

    first_move = input(
        "You find yourself at a crossroads. Which way would you like to go? Type \"left\" or \"right\"\n")
    if first_move == "left" or first_move == "Left":
        ...
        if second_move == "wait" or second_move == "Wait":
            third_move = (input(
                "The ferryman greets you warmly and launches into a long tale about his wife and son, filling the air with stories as the boat drifts across the water. "
            ...
            if third_move == "red" or third_move == "Red":
                print(
                    "You touch the iron handle to the red door, and before you can even blink, you hear the sound of heavy, guttural breathing behind you, and you feel a searing white pain shooting through your neck. "
                    "The goblin has found you, and now, you have no head. You are dead.")
            elif third_move == "green" or third_move == "Green":
                print(
                    "You turn the brass handle on the green door and are instantly met with the comforting scent of fresh honey, cold ale, and meat bubbling on the stove. "
            ...
            print("You decide to take a deep breath and leap into the lake, determined to swim across. "
                  ...
                  "Regret is brief. "
                  "The End.")
    elif first_move == "Right" or first_move == "right":
        print(
            "You trip over an uneven dirt path, fall into a conveniently placed hole, and… congratulations, you are dead.")
    else:
        print("Left. Right. Two options. Somehow, you manage to choose neither. A rare talent. "
              "While you admire your achievement, an owlbear finds you and eats you. You are dead.")
